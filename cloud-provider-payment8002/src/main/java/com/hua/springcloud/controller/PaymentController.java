...
import com.hua.springcloud.service.PaymentService;
...
public class PaymentController {
    ...
    @Value("${server.port}")
    private String serverPort;//读取到yml文件的port

    @Resource
    private DiscoveryClient discoveryClient;

    @RequestMapping(value = "/payment8002/discovery")
    ...
    public CommonResult getPaymentById(@PathVariable("id") Long id){
        ...
        if (paymentById != null){
            return new CommonResult(200,"查询数据成功:"+serverPort,paymentById);
        }else {
